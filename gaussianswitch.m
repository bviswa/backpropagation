% The Thresholds are gaussian distributed around the threshold, with a SD of ? 
%t SImulate the Switch Model for the drop of BFD sessions as a parameter of 
%th1 - CPU utilization 
%th2 - mem utilization  
%th3 - HWQueues 
%th4 - KernelQueues 
...
function [s me] = gaussianswitch(th1, th2, th3, th4, th5, sd, NUM, init) 
